...
<div class="nav-box">
    <ul>
        ...
        <li class="nav-item"><a
                href="${pageContext.request.contextPath}/admin/configregistration">Självregistrering</a></li>
        <li class="nav-item"><a
                href="${pageContext.request.contextPath}/admin/config">Konfiguration</a></li>
        <li class="nav-item"><a
